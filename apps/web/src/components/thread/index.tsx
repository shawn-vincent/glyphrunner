...
export function Thread() {
  ...
  return (
    ...
    >
      ...
      >
        {!chatStarted && (
          <div className="absolute top-0 left-0 w-full flex items-center justify-between gap-3 p-2 app-padding-top app-padding-x z-10">
            <div>
        ...
        {chatStarted && (
          <div className="flex items-center justify-between gap-3 p-2 app-padding-top app-padding-x z-10 relative">
        ...
        >
          <StickyToBottomContent
            className={cn(
              "absolute app-padding-x inset-0 overflow-y-scroll overscroll-contain [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-transparent",
        ...
        {/* Bottom Bar */}
        <div className="relative border-t bg-background app-padding-bottom z-10">
          <div className="absolute inset-x-0 bottom-full h-5 bg-gradient-to-t from-background to-background/0" />
          
          <div className="p-4 app-padding-x">
